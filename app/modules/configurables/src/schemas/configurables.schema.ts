...
export const configurableSchemas: ConfigurableSchemas = {
  formSchema: [
    ...
    // ── ZimSpots App Content ────────────────────────────────────────────────
    { fieldName: "tagline", type: "string", required: false, label: "App Tagline" },
    { fieldName: "heroSubtitle", type: "string", required: false, label: "Hero Subtitle" },
    { fieldName: "searchPlaceholder", type: "string", required: false, label: "Search Bar Placeholder" },
...

    {
      ...
      item: {
        ...
        fields: [
          { fieldName: "id", type: "string", required: true, label: "ID" },
          { fieldName: "name", type: "string", required: true, label: "Region Name" },
          { fieldName: "imageUrl", type: "url", required: false, label: "Cover Image URL" },
          { fieldName: "isActive", type: "boolean", required: false, label: "Active (not Coming Soon)" },
        ],
      },
    },

    {
      ...
      item: {
        type: "object",
        fields: [
          { fieldName: "id", type: "string", required: true, label: "Badge ID" },
          { fieldName: "name", type: "string", required: true, label: "Badge Name" },
          { fieldName: "description", type: "string", required: false, label: "Description" },
          { fieldName: "icon", type: "string", required: false, label: "Icon" },
          { fieldName: "requiredSpots", type: "number", required: true, label: "Spots Required" },
        ],
      },
    },

    { fieldName: "showOfflinePacksFeature", type: "boolean", required: false, label: "Show Offline Packs Feature" },
    { fieldName: "showCrowdsourcingFAB", type: "boolean", required: false, label: "Show Add a Spot FAB" },
    { fieldName: "defaultRegion", type: "string", required: false, label: "Default Region (launch city)" },
    { fieldName: "trendingGridColumns", type: "number", required: false, label: "Trending Grid Columns" },
    { fieldName: "maxTrendingSpots", type: "number", required: false, label: "Max Trending Spots Shown" },
  ],
};